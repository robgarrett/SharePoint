...
namespace DemoUserApp
{
    ...
    internal class FileCache : TokenCache
    {
        ...
        // If the file is already represent, it loads its content in the ADAL cache
        ...
        void AfterAccessNotification(TokenCacheNotificationArgs args)
        {
            ...
            lock (FileLock)
            {
                ...
                File.WriteAllBytes(CacheFilePath, ProtectedData.Protect(Serialize(), null, DataProtectionScope.CurrentUser));
